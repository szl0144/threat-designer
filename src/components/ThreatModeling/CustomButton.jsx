...
export const ImpactIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g id="SVGRepo_iconCarrier">
      ...
      ></path>{" "}
      <path d="M12 8V13" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"></path>{" "}
...
export const TargetIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g id="SVGRepo_iconCarrier">
      {" "}
      <path d="M2 12L5 12" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"></path>{" "}
      <path d="M19 12L22 12" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"></path>{" "}
      <path d="M12 22L12 19" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"></path>{" "}
      <path d="M12 5L12 2" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"></path>{" "}
      <path
        d="M10 12H12H14"
        stroke="#1C274C"
        stroke-width="1.5"
